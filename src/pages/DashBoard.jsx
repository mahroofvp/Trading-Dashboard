...
import StraightBarChart from '../components/StraightBarChart';
...
const DashBoard = () => {
    return (
        <div className='min-h-[100vh] w-[100%]' >
            ...
            <div className='h-37   w-full grid grid-cols-5 grid-flow-row  gap-3 pl-4 pr-4'>
                <div className='bg-white m-2 rounded-xl p-3 h-max '>
                ...
                <div className='bg-white m-2 rounded-xl p-3 flex items-center '>
                    ...
                    <div className='w-[60%]'>
                        <div className='flex items-center gap-2'>
                            <h3 className='text-gray-500 text-md '>Trade Win %</h3>
                            <div className='h-4 w-4 flex justify-center items-center 
                        border-[1px] border-gray-800  rounded-full text-[10px]'>i</div>
                        </div>
                        <h1 className=' h-16 flex items-center text-black text-[21px] font-bold '>16.67%</h1>
                    </div>

                    <div className='flex h-[85%] w-[40%]  items-center justify-center'>
                        <SemiDoughnutChart winners={3} breakeven={0} losers={15} circleDeg={180} size={"90%"} />
                    </div>
                </div>
                ...
                <div className='bg-white m-2 rounded-xl p-3 flex items-center '>
                    ...
                    <div className='w-[60%]'>
                        <div className='flex items-center gap-2'>
                            <h3 className='text-gray-500 text-md '>Profit Factor</h3>
                            <div className='h-4 w-4 flex justify-center items-center 
    border-[1px] border-gray-800  rounded-full text-[10px]'>i</div>
                        </div>
                        <h1 className=' h-16 flex items-center text-black text-[23px] font-bold '>0.30</h1>
                    </div>

                    <div className='flex h-[85%] w-[40%]  items-center justify-center'>
                        <SemiDoughnutChart winners={2} breakeven={0} losers={13} circleDeg={360} size={"70%"} />
                    </div>
                </div>
                ...
                <div className='bg-white m-2 rounded-xl p-3 flex items-center '>
                    ...
                    <div className='w-[60%]'>
                        <div className='flex items-center gap-2'>
                            <h3 className='text-gray-500 text-md '>Day Win %</h3>
                            <div className='h-4 w-4 flex justify-center items-center 
    border-[1px] border-gray-800  rounded-full text-[10px]'>i</div>
                        </div>
                        <h1 className=' h-16 flex items-center text-black text-[21px] font-bold '>13.33%</h1>
                    </div>

                    <div className='flex h-[85%] w-[40%]  items-center justify-center'>
                        <SemiDoughnutChart winners={2} breakeven={1} losers={13} circleDeg={180} size={"90%"} />
                    </div>
                </div>
                ...
                <div className='bg-white m-2 rounded-xl p-3'>
                    ...
                    <div className='flex items-center'>
                        <h1 className='h-16 flex items-center text-black text-[22px] font-bold '>1.49</h1>
                        <div className='ml-6'>
                        <StraightBarChart/>
                        <div className='flex  justify-between'>
                        <h6 className='text-emerald-500 text-sm font-bold' >2.9K</h6>
                        <h6 className='text-red-500 text-sm font-bold'>1.95K</h6>
                        </div>
                        </div>
                    </div>
                </div>
